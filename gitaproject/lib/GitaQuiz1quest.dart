...
class GitaQuiz1quest extends StatefulWidget {
  @override
  _GitaQuiz1questState createState() => _GitaQuiz1questState();

  static indexof(Map category) {}
}

class _GitaQuiz1questState extends State<GitaQuiz1quest> {
  static List<dynamic> item = Questions.questions;
  List<dynamic> items = item.sublist(0, 1)..shuffle();
...
//   // int size = 3;
//   static List<dynamic> item = Questions.questions;
//   List<dynamic> items = item.sublist(0, 1);
//   var rightAnswerCount = 0;
//   var wrongAnswerCount = 0;
//   var currentIndex = 0;
//   validateAnswer(userInput) {
...
//                                 onPressed: () {
//                                   validateAnswer(
//                                       items[currentIndex]['option1']);
//                                 },
//                                 child: Text('${items[currentIndex]['option1']}',
//                                     style: TextStyle(color: Colors.red))),
//                           ),
//                         ),
//                         Container(
...
//                                 onPressed: () {
//                                   validateAnswer(
//                                       items[currentIndex]['option2']);
//                                 },
//                                 child: Text('${items[currentIndex]['option2']}',
//                                     style: TextStyle(color: Colors.red))),
//                           ),
//                         ),
//                         Container(
...
//                                 onPressed: () {
//                                   validateAnswer(
//                                       items[currentIndex]['option3']);
//                                 },
//                                 child: Text('${items[currentIndex]['option3']}',
//                                     style: TextStyle(color: Colors.red))),
//                           ),
//                         ),
//                         Container(
...
//                                 onPressed: () {
//                                   validateAnswer(
//                                       items[currentIndex]['option4']);
//                                 },
//                                 child: Text('${items[currentIndex]['option4']}',
//                                     style: TextStyle(color: Colors.red))),
//                           ),
//                         ),
//                         // Container(
